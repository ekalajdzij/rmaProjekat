        ...
        fun getAll() :List<Game> {
            return listOf(
                Game(
                    ...
                    mutableListOf(UserReview("alexisManFromColombia", 4, "A really nice game to play with friends"),
                        ...
                        UserReview("PESnerd", 1, "Feel from the game really is not any good"),
                        UserRating("johnn123", 1, 3.3),
                        UserReview("gamer4life", 3, "Not that good, not that bad, average"),
